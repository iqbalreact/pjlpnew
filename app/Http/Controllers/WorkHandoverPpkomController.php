...
use App\Http\Requests\WorkHandoverPpkomRequest;
...
class WorkHandoverPpkomController extends Controller
{
    public function __construct(
        WorkHandoverPpkomBussInterface $workHandover,
    ...
    {
        return view('admin.workHandoverPpkom.index');
    }
    ...
    public function create()
    {
        ...
        $initSection2   = "<p>Berdasarkan Berita Acara Serah Terima Hasil Pekerjaan Nomor 003.1.e/BAHPP/Pontive/PET/DISKOMINFO/II/2019 tanggal 1 Februari 2019 beserta lampirannya, dengan ini menyatakan telah mengadakan Serah Terima Pekerjaan Belanja Jasa Petugas Bidang Komunikasi, Informatika dan Statistika, Jasa Admin Pontive Center (Pengelola Teknologi Informasi) Kegiatan Operasional Pontive Center Kota Pontianak dengan hasil sebagai berikut:</p>";
        ...
        <ol>
            <li>PIHAK KEDUA telah melaksanakan pekerjaan dan menyerahkan hasilnya kepada PIHAK PERTAMA dengan kondisi baik sesuai dengan :
                <ul>
                    <li>SPK Nomor 03.2.5/SPK/Pontive/PET/DISKOMINFO/I/2019 tanggal 14 Januari 2019</li>
                    <li>SPMK Nomor 03.3.5/SPMK/Pontive/PET/DISKOMINFO/I/2019 tanggal 14 Januari 2019</li>
                </ul>
            </li>
            <li>PIHAK PERTAMA telah menerima hasil pekerjaan dari PIHAK KEDUA dengan kondisi baik sesuai dengan :
                <ul>
        ...
        <p>Penyerahan sebagaimana dimaksud berupa : Jasa Lainnya Orang Perorangan Belanja Jasa Petugas Bidang Komunikasi, Informatika dan Statistika, Jasa Admin Pontive Center (Pengelola Teknologi Informasi) selama 1 (satu) bulan (Januari) dengan rincian pekerjaan sebagaimana tertuang dalam Syarat Umum Surat Perintah Kerja.</p>";
        ...
        return view('admin.workHandoverPpkom.create', compact('initNumber', 'initSection1', 'initSection2', 'initSection3', 'initSection4', 'skpd'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(WorkHandoverPpkomRequest $request)
    {
        $data = $this->workHandover->store($request);

        if (!$data) {
            notify()->warning('PJLP tidak mempunyai aktif kontrak');
            return redirect()->route('workHandoverPpkom.index');
        }
    ...
    public function show($id)
    {
        ...
        return view('admin.workHandoverPpkom.show', compact('data'));
    }
    ...
    public function export($id)
    {
        ...
        $pdf = PDF::setOptions(['isHtml5ParserEnabled' => true, 'isRemoteEnabled' => true])->loadView('admin.workHandoverPpkom.export', compact('data', 'date'))->setPaper(array(0, 0, 612, 935.433), 'portrait');
    ...
    public function edit($id)
    {
        ...
        return view('admin.workHandoverPpkom.edit', compact('data'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(WorkHandoverPpkomRequest $request, $id)
    {
