<form class="form-horizontal">
    ...
    @if($contract)
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <h3>{{ $contractInformation->skpd->name }}</h3>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <h3>{{ $contractInformation->program->name }}</h3>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <h3>{{ $contractInformation->activity->name }}</h3>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <h3>{{ $contractInformation->workPackage->name }}</h3>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <h3>{{ $contractInformation->position->name }}</h3>
            </div>
        </div>
