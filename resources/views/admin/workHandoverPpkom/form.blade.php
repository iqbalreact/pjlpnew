<div class="box-body">
    ...
    @if(isset($data->functionary2))
        <div class="form-group {{ $errors->has('functionary2_id') ? 'has-error' : '' }}"">
            <label for="inputEmployee" class="col-sm-2 control-label">Pejabat PA @include('components.required')</label>

            <div class="col-sm-10">
                <input type="text" value="{{ $data->functionary2->name }}" class="form-control" readonly>
                <input name="functionary2_id" type="hidden" value="{{ $data->functionary2->id }}">

                @if ($errors->has('functionary2_id'))
                    <span class="help-block">{{ $errors->first('functionary2_id') }}</span>
                @endif
            </div>
        </div>
    @else
        <div class="form-group {{ $errors->has('functionary2_id') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-10">
                <select name="functionary2_id" id="functionary2Select" class="form-control"></select>
