<form class="form-horizontal">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">Pejabat PPHP</label>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input class="form-control" value="Pejabat Pemeriksa Hasil Pekerjaan pada {{ $data->skpd->name ?? '' }} Kota Pontianak" readonly>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <a href="{{ route('export.workAdministration', $data->id) }}" class="btn btn-primary">
                Download Surat
            </a>
        </div>
    </div>
