<div class="box-body">
    ...
    <div class="form-group {{ $errors->has('work_type') ? 'has-error' : '' }}">
        <label for="inputName" class="col-sm-2 control-label">Macam Pekerjaan @include('components.required')</label>

        <div class="col-sm-10">
            {!! Form::text('work_type', $edit ? $data->work_type : '', ['class' => 'form-control', 'placeholder'=> __('Macam Pekerjaan'), 'required' => true] ) !!}
            
            @if ($errors->has('work_type'))
                <span class="help-block">{{ $errors->first('work_type') }}</span>
            @endif
        </div>
    </div>

    <div class="form-group {{ $errors->has('term') ? 'has-error' : '' }}">
        <label for="inputName" class="col-sm-2 control-label">Syarat-Syarat Pekerjaan @include('components.required')</label>

        <div class="col-sm-10">
            {!! Form::text('term', $edit ? $data->term : '', ['class' => 'form-control', 'placeholder'=> __('Syarat-Syarat Pekerjaan'), 'required' => true] ) !!}
    ...
    <div class="form-group {{ $errors->has('period') ? 'has-error' : '' }}">
        <label for="inputName" class="col-sm-2 control-label">Waktu Penyelesaian @include('components.required')</label>

        <div class="col-sm-10">
            {!! Form::text('period', $edit ? $data->period : '', ['class' => 'form-control', 'placeholder'=> __('Waktu Penyelesaian'), 'required' => true] ) !!}
    ...
    <div class="form-group {{ $errors->has('fine') ? 'has-error' : '' }}">
        <label for="inputName" class="col-sm-2 control-label">Denda @include('components.required')</label>

        <div class="col-sm-10">
            {!! Form::text('fine', $edit ? $data->fine : '', ['class' => 'form-control', 'placeholder'=> __('Denda'), 'required' => true] ) !!}
            
            @if ($errors->has('fine'))
                <span class="help-block">{{ $errors->first('fine') }}</span>
            @endif
        </div>
    </div>
